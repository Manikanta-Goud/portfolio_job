...
const VARIANTS = {
    ...
    purple: { activeColor: '#e9d5ff', gap: 5, speed: 30, colors: '#e9d5ff,#c084fc,#7c3aed', noFocus: false },
};
...
export default function PixelCard({ variant = 'default', gap, speed, colors, noFocus, className = '', children }) {
    ...
    return (
        <div
            ...
            onFocus={finalNoFocus ? undefined : e => { if (e.currentTarget.contains(e.relatedTarget)) return; handleAnimation('appear'); }}
            onBlur={finalNoFocus ? undefined : e => { if (e.currentTarget.contains(e.relatedTarget)) return; handleAnimation('disappear'); }}
